...
import com.bytatech.ayoos.doctor.client.dms.model.RenditionBodyCreate;
import com.bytatech.ayoos.doctor.client.dms.model.RenditionEntry;
import com.bytatech.ayoos.doctor.client.dms.model.RenditionPaging;
...
public interface RenditionsApi {
    ...
    @ApiOperation(value = "Get rendition content", nickname = "getRenditionContent", notes = "**Note:** this endpoint is available in Alfresco 5.2 and newer versions.  Gets the rendition content for **renditionId** of file **nodeId**. ", tags={ "renditions", })
    @ApiResponses(value = { 
